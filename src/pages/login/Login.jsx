        ...
        <div className={style.login}>
           ...
           <div className={style.fields}>
               ...
               <svg className="svg-icon" viewBox="0 0 20 20">
                   ...
                   <input type="email" name="email" placeholder="email" value={loginData?.email} onChange={(e)=>{setLoginData(preveState=>{
                       return {
                           ...preveState,
               ...
               <input type="password" name="password" placeholder="password" value={loginData?.password} onChange={(e)=>{setLoginData(preveState=>{
                       return {
                           ...preveState,
            ...
            <button onClick={onSubmit} className={style.signinBtn}>Login</button> 
